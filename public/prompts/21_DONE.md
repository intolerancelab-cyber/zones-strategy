...
**Band-find cross-cell (3-of-4) ≠ Stage-12 boost-count confluence (2/3/4 B×S)** — both remain named separately in the sealed index.
...
- **Ask David before locking Continuation** (PLACEHOLDER is not operable OPEN).
