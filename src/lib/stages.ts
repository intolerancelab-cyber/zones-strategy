...
export const STAGES: StageDef[] = [
  ...
  { id: 10, title: "Boost-alone", kind: "WORK", promptFile: "10_BOOST_ALONE_WORK.md", note: "Candidate B×S; Q6 FOR NOW=single-boost recipes only; Stage-12 after 11" },
  { id: 11, title: "Boost-alone check", kind: "CHECK", promptFile: "11_BOOST_ALONE_CHECK.md", note: "Cost shock + trade-count floor; Q5 WF held back; Q6 single-recipe" },
  { id: 12, title: "Stage-12 boost-count confluence", kind: "WORK", promptFile: "12_CONFLUENCE_WORK.md", note: "2/3/4 B×S; Q4; Q5 WF score stamp; Q6 borrow-single; cut PF>1.2; draw-a-line FOR NOW" },
  { id: 13, title: "Stage-12 boost-count confluence check", kind: "CHECK", promptFile: "13_CONFLUENCE_CHECK.md", note: "Take-table + Q4 + Q5 WF stamp; weak WF blocks; Q6 FOR NOW borrow-single; never-1B WARN" },
  ...
  { id: 21, title: "Done", kind: "DONE", promptFile: "21_DONE.md", note: "Q4+Q5 LOCKED; Q6 FOR NOW disclosed; OPEN to revise" },
];
