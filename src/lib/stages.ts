...
export const STAGES: StageDef[] = [
  ...
  { id: 3, title: "Baseline check", kind: "CHECK", promptFile: "03_BASELINE_CHECK.md", note: "Champion talk if needed" },
  ...
  { id: 6, title: "Band find", kind: "WORK", promptFile: "06_BAND_FIND_WORK.md", note: "Under ~0.75 → SKIP; ≥~0.75 → sweep candidate" },
  ...
  { id: 10, title: "Boost-alone", kind: "WORK", promptFile: "10_BOOST_ALONE_WORK.md", note: "Mark B×S table; unlocks confluence" },
  { id: 11, title: "Boost-alone check", kind: "CHECK", promptFile: "11_BOOST_ALONE_CHECK.md", note: "Cost shock + trade-count floor" },
  { id: 12, title: "Confluence", kind: "WORK", promptFile: "12_CONFLUENCE_WORK.md", note: "2/3/4 on allowlisted squares" },
  { id: 13, title: "Confluence check", kind: "CHECK", promptFile: "13_CONFLUENCE_CHECK.md", note: "Take rule / holy-grail + dependence" },
